...
import (
	...
	errorv1 "github.com/zhengyansheng/jupiter/proto/error/v1"
...
const (
	xerrorPkg          = protogen.GoImportPath("github.com/zhengyansheng/jupiter/pkg/util/xerror")
...
func generateFile(gen *protogen.Plugin, file *protogen.File) *protogen.GeneratedFile {
	...
	g.P("// Code generated by github.com/zhengyansheng/jupiter/cmd/protoc-gen-go-xerror. DO NOT EDIT.")
	g.P("// versions:")
	...
	g.P("// is compatible with the github.com/zhengyansheng/jupiter/cmd/protoc-gen-go-xerror package it is being compiled against.")
